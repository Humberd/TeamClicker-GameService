package com.teamclicker.gameservice.validators;

import com.teamclicker.gameservice.security.RoleType
...
annotation class ValidateRoles(
    val message: String = "{com.teamclicker.gameservice.validators.ValidateRoles.message}",
